...
A criação do famos o game Flappy Bird usando a linguagem Python.
Neste código você pode jogar manualmente como o jogo original ou uma IA pode jogar por você.
